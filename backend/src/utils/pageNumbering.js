...
function toRomanNumeral(num, options = {}) {
...
function formatHybridPageNumber(absolutePageNumber, options = {}) {
  const {
...
function formatHybridPageNumberLabel(absolutePageNumber, options = {}) {
  const {
...
function buildPgNumTypeXml(fmt, startAttr = null) {
...
function generateHybridPageSeries(totalPages, options = {}) {
...
module.exports = {
  toRomanNumeral,
  romanToArabic,
  formatHybridPageNumber,
  formatHybridPageNumberLabel,
  buildPgNumTypeXml,
  buildSectionBreakXml,
  generateHybridPageSeries
};
