...
const calendarReminderService = require('./services/calendarReminderService');
...
app.listen(port, () => {
  ...
  calendarReminderService.scheduleProcessing();
  console.log('Calendar event reminder scheduler initialized');
});
