...
const ROUTE_PRIORITY = [
  ...
  { path: '/documents/my-documents', module: 'myDocumentsStatus' },
  { path: '/documents/drafts', module: 'documents.draft' },
  { path: '/documents/review-approval', module: 'documents.review' },
  { path: '/documents/published', module: 'documents.published' },
  { path: '/documents/archived', module: 'documents.superseded' },
