        ...
        {visibleDays.map((d, idx) => {
          ...
          return (
            <button
              ...
              className={[
                'group relative min-h-[60px] sm:min-h-[72px] border-b border-r border-[var(--dms-color-border-default)] text-left p-1 transition-all duration-200 overflow-hidden',
                inMonth
